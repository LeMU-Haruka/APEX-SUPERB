...
from src.models.desta25_modules.utils.audio import AudioSegment
...
class QformerConnector(nn.Module):
    def __init__(self, config):
        ...
        elif 'whisper-large-v3' in self.config.encoder_model_id:
...
class DeSTA25Config(PretrainedConfig):
    ...
    def __init__(self, 
                 llm_model_id="/extrahome0/xiejingran/models/Llama-3.1-8B-Instruct",
                 encoder_model_id="/extrahome0/xiejingran/models/whisper-large-v3",
