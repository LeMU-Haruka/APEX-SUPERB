...
# from src.models.qwen3_omni import Qwen3Omni
...
from src.models.step_audio2 import StepAudio2Mini
...
models_map = {
    ...
    #'qwen3-omni': Qwen3Omni, # https://huggingface.co/Qwen/Qwen3-Omni-30B-A3B-Instruct
